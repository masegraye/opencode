...
export function DialogElicitation(props: DialogElicitationProps) {
  ...
  return (
    <box paddingLeft={2} paddingRight={2} gap={1}>
      ...
      <box paddingTop={1}>
        <Show when={activeField().type === "boolean"}>
          <text fg={theme.textMuted}>
        ...
        <Show when={activeField().type === "number" || activeField().type === "integer"}>
          <text fg={theme.textMuted}>
        ...
        <Show when={activeField().type === "string"}>
          <text fg={theme.textMuted}>
            (Text editing not yet implemented) Press <span style={{ fg: theme.text }}>↑↓</span> to navigate, {" "}
            <span style={{ fg: theme.text }}>return</span> to confirm
          </text>
        </Show>
      </box>
